...
func main() {
	...
	r.POST("/api/payment-recipients", handlers.CreatePaymentRecipient(paymentClient))
	r.GET("/api/payment-recipients", handlers.GetPaymentRecipients(paymentClient))
	r.DELETE("/api/payment-recipients/:id", handlers.DeletePaymentRecipient(paymentClient))
