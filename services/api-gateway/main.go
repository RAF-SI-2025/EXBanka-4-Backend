...
func main() {
	...
	r.POST("/auth/totp/generate", middleware.RequireRole("READ", "CLIENT"), handlers.TOTPGenerate(authClient))
	r.POST("/auth/totp/verify", middleware.RequireRole("READ", "CLIENT"), handlers.TOTPVerify(authClient))
	r.POST("/auth/totp/validate", handlers.TOTPValidateLogin(authClient))
	r.DELETE("/auth/totp", middleware.RequireRole("READ", "SUPERVISOR", "AGENT", "CLIENT"), handlers.TOTPDisable(authClient))
