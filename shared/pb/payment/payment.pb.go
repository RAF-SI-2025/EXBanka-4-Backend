...
var file_payment_proto_goTypes = []any{
	(*PaymentRecipient)(nil),      // 0: payment.PaymentRecipient
...
var file_payment_proto_depIdxs = []int32{
	...
	2, // 1: payment.PaymentService.CreatePayment:output_type -> payment.CreatePaymentResponse
